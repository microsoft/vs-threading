namespace Microsoft.VisualStudio.Threading.Analyzers.Tests
{
    ...
    public class VSSDK012SpecifyJtfWhereAllowedTests : DiagnosticVerifier
    {
        private DiagnosticResult expect = new DiagnosticResult
        {
            Id = VSSDK012SpecifyJtfWhereAllowed.Id,
            SkipVerifyMessage = true,
            Severity = DiagnosticSeverity.Warning,
        };

        public VSSDK012SpecifyJtfWhereAllowedTests(ITestOutputHelper logger)
            : base(logger)
        {
        }

        protected override DiagnosticAnalyzer GetCSharpDiagnosticAnalyzer() => new VSSDK012SpecifyJtfWhereAllowed();
